        ...
        <>
            ...
            <div className="container px-5 py-20 mx-auto flex">
                <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col mx-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                    <h2 className="text-gray-900 text-2xl mb-1 font-medium text-center">Forgot Password</h2>
                    <form onSubmit={handleSubmit} className='flex flex-col justify-center' >
                        ...
                        <button className="text-white bg-indigo-700 disabled:bg-indigo-300 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-900 rounded text-lg" disabled={buttonDisabled}>{loading ? "Processing" : "Submit"}</button>
